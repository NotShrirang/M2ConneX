    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ForeignKey(db_column='blog_id', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='blog.blog', verbose_name='Blog')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatedAt', models.DateTimeField(auto_now=True)),
                ('isActive', models.BooleanField(default=True)),
                ('action', models.CharField(choices=[('like', 'Like'), ('dislike', 'Dislike'), ('report', 'Report')], db_column='action', max_length=10, verbose_name='Action')),
